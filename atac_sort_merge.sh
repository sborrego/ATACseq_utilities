...
pos2bed.pl ${PEAK_200}/${INPUT_PREFIX}/${INPUT_PREFIX}_peak200.txt > ${PEAK_200}/${INPUT_PREFIX}/${INPUT_PREFIX}_peak200.not_fixed.bed
pos2bed.pl ${PEAK_500}/${INPUT_PREFIX}/${INPUT_PREFIX}_peak500.txt > ${PEAK_500}/${INPUT_PREFIX}/${INPUT_PREFIX}_peak500.not_fixed.bed
...
${PEAK_500}/${INPUT_PREFIX}/${INPUT_PREFIX}_peak500.txt \
...
-i ${PEAK_MERGE}/${INPUT_PREFIX}.merge.bed > ${PEAK_FINAL}/${INPUT_PREFIX}.finalpeaks.txt 2>> ${RUNLOG}
